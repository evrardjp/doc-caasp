...
Component versions in worker0
  - kubelet: 1.14.1 -> {kube_version}
  - cri-o: 1.14.1 -> {kube_version}
----
...
Component versions in master0
  - apiserver: 1.14.1 -> {kube_version}
  - controller-manager: 1.14.1 -> {kube_version}
  - scheduler: 1.14.1 -> {kube_version}
  - etcd: 3.3.11 -> {etcd_version}
  - kubelet: 1.14.1 -> {kube_version}
  - cri-o: 1.14.1 -> {kube_version}
----
